...
v0.new("<Color=Cyan>Welcome to Van Nguyen Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(118299750128201) ;
...
v8.Image = "rbxassetid://118299750128201";
v8.Draggable = true;
...
v74:Button("Kaitun Cap", function(v471)
	...
	for v863, v864 in pairs(v472) do
		if (v495[v864] and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"   .. v864 , true) == 1)) then
			...
			v1663.Image = "rbxassetid://118299750128201";
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=118299750128201&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
