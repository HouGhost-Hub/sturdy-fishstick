...
ImageButton.Image = "http://www.roblox.com/asset/?id=118299750128201"
...
Tabs.Main0:AddButton({Title="Youtuber",Description="VTD Roblox",Callback=function() setclipboard("https://www.youtube.com/@VanNguyen-80") end})
Tabs.Main0:AddButton({Title="Tik Tok",Description="VTD Roblox",Callback=function() setclipboard("tiktok.com/@vannguyen_173") end})
Tabs.Main0:AddButton({Title="Facebook",Description="VTD Roblox",Callback=function() setclipboard("https://www.facebook.com/share/16rw4PyFBR/") end})
Tabs.Main0:AddButton({Title="Zalo",Description="VTD Roblox",Callback=function() setclipboard("https://zalo.me/g/vekjuk480") end})
