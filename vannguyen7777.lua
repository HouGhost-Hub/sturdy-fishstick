loadstring(game:HttpGet(("https://raw.githubusercontent.com/daucobonhi/Ui-Redz-V2/refs/heads/main/UiREDzV2.lua")))()
       ...
       local Window = MakeWindow({
         ...
         Animation = "Youtube: VanNguyen-80"
         },
        Key = {
        KeySystem = true,
        Title = "Buy [ FREE ] vannguyen740",
        Description = "Key Working",
        KeyLink = "https://discord.gg/DjQCdc8j",
        Keys = {"Smokerming"},
        Notifi = {
        Notifications = true,
        CorrectKey = "Success ✅",
       Incorrectkey = "No Working Key ❌",
...
------ Tab
     ...
     local Tab10o = MakeTab({Name = "99 Đêm Trong rừng"})
