...
local BloxFruits = game.GameId == 2753915549
local GymShowdown = game.GameId == 1234567890
...
elseif GymShowdown then
    loadScript("https://raw.githubusercontent.com/HouGhost-Hub/sturdy-fishstick/refs/heads/main/GSS.lua")
elseif
