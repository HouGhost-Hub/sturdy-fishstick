...
local Window = Rayfield:CreateWindow({
   Name = "99 Nights In The Forest - Script By Van Nguyen",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "99 Nights In The Forest",
   LoadingSubtitle = "Script By Van Nguyen",
   ...
   Discord = {
      ...
      Invite = "https://discord.gg/hNjWyVcF", -- The Discord invite code, do not include discord.gg/hNjWyVcF. E.g. discord.gg/hNjWyVcF ABCD would be ABCD
   ...
   KeySettings = {
      ...
      FileName = "VANNGUYEN-F97-J98-QL9-123", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
...
local DiscordLink = DiscordTab:CreateButton({
   Name = "Discord Link",
   Callback = function()
copyToClipboard("https://discord.gg/hNjWyVcF")
end,
})
...
local Dropdown = SettingsTab:CreateDropdown({
   Name = "Change Theme",
   Options = {"Default", "Amber Glow", "Amethyst", "Bloom", "Dark Blue", "Green", "Light", "Ocean", "Dark", "Darker", "Serenity"},
