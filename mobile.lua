...
Button.Image = "rbxassetid://118299750128201"
...
Tabs.Info:AddButton({
        ...
        Description="Discord",
        Callback=function()
            setclipboard(tostring("https://discord.gg/scNJmuMb")) 
        end
})
Tabs.Info:AddButton({
    Title="YTB Van Nguyen",
    Description="Youtube",
    Callback=function()
...
Tabs.Info:AddButton({
    ...
    Callback=function()
        setclipboard(tostring("https://www.facebook.com/share/1CMsybRdGH/"))
    end
})
