...
shared.LoaderTitle = "Tik Tok : Ngọc Nguyễn";
Text = "ID Tik Tok: ngocnguyen0972",
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://80196398184635",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=99297352556040";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/czWHrPTM");
    end
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("NoMone: " .. tostring(v768) .. " Boen");
            end
        end);
    end);
...
if Sea3 then
    local v490 = v16.Main:AddSection(""Commander Cake");
...
if Sea3 then
    local v531 = v16.Sea:AddSection("Mystic Island");
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("Mystic Island: " .. MirageStatus .. " | FullMoon: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
        Title = "Tp Island Kitsune",
        Description = "",
        Callback = function()
            TweenToHighestPoint();
        end
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://80196398184635") then
                    return v729;
                end
            end
        end
...
local v93 = v16.Setting:AddSection("Proficiency Skills");
local v94 = v16.Setting:AddToggle("ToggleZ", {
    Title = "Proficiency Skills Z",
    Description = "",
    Default = true
});
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "Humanand ghoul[Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v166 = v16.Sea:AddParagraph({
    Title = "Success Draco V4 (Sớm Ra)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "TP Buy Trial Race Draco",
    Description = "",
    Default = false
});
