...
v0.new("<Color=Cyan>Welcome to HouGhost HouGhost Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(91521936822360) ;
	...
	v197.Text = "HouGhost HouGhost Hub";
	v197.TextSize = 17;
...
v8.Image = "rbxassetid://91521936822360";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "HouGhost HouGhost Hub",
	Text = "Successfully Loading...",
	Icon = "rbxthumb://type=Asset&id=91521936822360&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
