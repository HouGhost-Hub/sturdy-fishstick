...
local Window = Fluent:CreateWindow({
    Title="HouGhost Hub[ Blox Fruit ]",
    SubTitle="  buy orenzoiun", 
    TabWidth=180, 
    Theme="red",
    Acrylic=false,
    Size=UDim2.fromOffset(555, 414), 
...
toggleButton.Image = "rbxassetid://91521936822360"
...
local Tabs = {local Tabs = {
    ...
    Melee = Window:AddTab({ Title = "Tab Auto Get Melee V2"", Icon = "sword" }),
...
Tabs.Main:AddButton({
        ...
        Description="https://discord.gg/cwsTyeuB",
        Callback=function()
            setclipboard(tostring("https://discord.gg/cwsTyeuB")) 
        end
})
Tabs.Main:AddSection("Main")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Update Auto Farm Level 2650-2800 New", Default = false})
...
local Initialize = Tabs.Settings:AddToggle("Initialize", {Title = "Initialize Attack [M1/Melee/Sword]", Description = "[ Not Supported Gas,Pain M1 ]", Default = true})
