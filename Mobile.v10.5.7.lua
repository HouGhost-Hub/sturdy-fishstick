...
local Window = Fluent:CreateWindow({
    Title = "HOUGHOST Hub v10.5.7 Buy",
    SubTitle = "orenzoiun",
    TabWidth = 180,
    Size = UDim2.fromOffset(555, 440),
    Acrylic = false,
    Theme = "Dark",
...
local Tabs = {
    ...
    New = Window:AddTab({ Title = "Tab Events", Icon = "sparkles" }),
    SeaEvent = Window:AddTab({ Title = "Tab Sea Events", Icon = "ship" }),
    ...
    Raids = Window:AddTab({ Title = "Tab Raid + Law", Icon = "fire" }),
    Combat = Window:AddTab({ Title = "Tab PvP", Icon = "zap" }),
...
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {
    ...
    Description = "Auto Farm Level, Stable",
    Default = false
})
