...
shared.LoaderTitle = "Tik Tok Văn Nguyên";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://91347148253026",
...
local v16 = {
    Home = v15:AddTab({ Title = "Thông Tin", Icon = "book" }),
    Main = v15:AddTab({ Title = "Cày Cấp", Icon = "zap" }),
    Sea = v15:AddTab({ Title = "Sự Kiện", Icon = "water" }),
    ITM = v15:AddTab({ Title = "Vật Phẩm", Icon = "bag" }),
    Setting = v15:AddTab({ Title = "Cài Đặt", Icon = "settings" }),
    Status = v15:AddTab({ Title = "Máy Chủ", Icon = "server" }),
    Stats = v15:AddTab({ Title = "Chỉ Số", Icon = "chart" }),
    Player = v15:AddTab({ Title = "Người Chơi", Icon = "user" }),
    Teleport = v15:AddTab({ Title = "Dịch Chuyển", Icon = "compass" }),
    Visual = v15:AddTab({ Title = "Giả", Icon = "eye" }),
    Fruit = v15:AddTab({ Title = "Trái", Icon = "apple" }),
    Raid = v15:AddTab({ Title = "Tập Kích", Icon = "sword" }),
    Race = v15:AddTab({ Title = "Tộc", Icon = "archery" }),
    Shop = v15:AddTab({ Title = "Cửa Hàng", Icon = "shop" }),
    Misc = v15:AddTab({ Title = "Tinh Linh", Icon = "sparkles" })
}
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/nX3dEDXQ");
    end
});
v16.Home:AddButton({
    Title = "Youtube",
    Description = "Giao Lưu",
    Callback = function()
        setclipboard("https://www.youtube.com/@VanNguyen-80");
    end
});
v16.Home:AddButton({
    Title = "Facebook",
...
local v99 = v16.Status:AddParagraph({
    ...
    Content = "━━━━━━━━━━━━━━━━━━━━━\n" ..
        ...
        "Cấp        : " .. game.Players.LocalPlayer.Data.Level.Value .. "\n" ..
        "Tiền       : " .. game.Players.LocalPlayer.Data.Beli.Value .. "\n" ..
        "Điểm F     : " .. game.Players.LocalPlayer.Data.Fragments.Value .. "\n" ..
        "Tiền Truy Nã: " .. game.Players.LocalPlayer.leaderstats["Bounty/Honor"].Value .. "\n" ..
        ...
        "Tộc        : " .. game.Players.LocalPlayer.Data.Race.Value .. "\n" ..
        "Trái       : " .. game.Players.LocalPlayer.Data.DevilFruit.Value .. "\n" ..
        "━━━━━━━━━━━━━━━━━━━━━"
});
local v100 = v16.Status:AddParagraph({
    Title = "Thời Gian",
    Content = "số lượng dự liệu"
});
local function v101()
...
local v139 = v16.Sea:AddToggle("ToggleKillAura", {
    Title = "Kill Aura",
    Description = "",
    Default = false
});
