...
shared.LoaderTitle = "Đăng Ký Kênh VanNguyen-80";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "Van Nguyen Hub://118299750128201",
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/DjQCdc8j");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "Van Nguyen Hub://118299750128201") then
                    return v729;
                end
            end
        end
